...
urlpatterns = [
    ...
    path('catalog/disciplinas/modal/<int:disciplina_id>/', views.disciplina_modal, name='disciplina_modal_edit'),
    ...
    path('catalog/teachers/modal/<int:teacher_id>/', views.teacher_modal, name='teacher_modal_edit'),
    path('catalog/disciplinas/crear/', views.create_disciplina, name='create_disciplina'),
    path('catalog/disciplinas/<int:disciplina_id>/editar/', views.update_disciplina, name='update_disciplina'),
    path('catalog/teachers/crear/', views.create_teacher, name='create_teacher'),
    path('catalog/teachers/<int:teacher_id>/editar/', views.update_teacher, name='update_teacher'),
    path('catalog/disciplinas/<int:disciplina_id>/delete/', views.delete_disciplina, name='delete_disciplina'),
    path('catalog/teachers/<int:teacher_id>/delete/', views.delete_teacher, name='delete_teacher'),
]
