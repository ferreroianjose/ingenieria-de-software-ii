...
urlpatterns = [
    ...
    path("list/<int:class_id>/inscriptos/", views.class_roster_drawer, name="class_roster_drawer"),
    path("list/student/<int:user_id>/enrollments/", views.student_enrollments_drawer, name="student_enrollments_drawer"),
